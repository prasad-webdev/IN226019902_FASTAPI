...
# Initial and newly added products for Q1
...
products = [
    ...
    {"id": 4, "name": "Water Bottle", "price": 499, "category": "Lifestyle", "in_stock": True},

    # Q1: Adding 3 more products
...
# Q4: Store Info Summary Endpoint
